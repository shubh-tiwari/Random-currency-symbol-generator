...
class Generator(object):
    def __init__(self, bgr_type=0, bgr_folder='../utils/backgrounds', bgr_color=None, 
                    font_color=(0,0,0), blur=0, orientation=0, flip=0, skew_angle=0, 
                    shear_param=0, font_dir='../utils/fonts'):
        """Initializes the parameters :
            ...
            10. font_dir = Directory containing all the fonts
        """
    ...
    def paste_symbol(self):
        ...
        font = rnd.choice(glob.glob(os.path.join(self.font_dir, '*.ttf')))
